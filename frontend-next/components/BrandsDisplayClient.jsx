    ...
    <div className="brand-display-page">
      <div className="brand-top-section">
        <div className="brand-top-content">
          <Link href="/brands" className="brand-back-link" aria-label="Go back to all brands">
        ...
        <>
          <div className="brand-products-grid">
            {firstProducts.map((product, index) => (
              <Link href="#" key={index} className="brand-product-card" aria-label={`View product: ${product.name}`}>
                <img src={product.image} alt={`${product.name} product image`} className="brand-product-image" />
